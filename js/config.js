...
export const config = {
  ...
  // Google Apps Script web app that receives every form submission.
  // Waiver → PDF + Drive + email; all forms → row in the submissions sheet.
  // See apps-script/README.md for the deployment steps. Empty = dev mode
  // (payload logged to console, success UI shown).
  FORMS_WEBHOOK_URL: 'https://script.google.com/macros/s/AKfycbxMaVUjQcLZJrqMpGNwmqkhvLh2u38OHDEOIjvlSftnP0XDOGsWmBWbpkVGfnZFj932/exec',
